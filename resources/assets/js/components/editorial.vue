            ...
            <!--<categoria></categoria> -->
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-file-text"></i> Editoriales 
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="texto" name="texto" v-model="buscar" class="form-control" placeholder="Texto a buscar" @keypress="listEdit(1, criterio,buscar)">
                                    <button type="submit"  @click="listEdit(1,criterio,buscar)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
